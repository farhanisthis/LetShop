...
const About = () => {
  return (
    <div className="p-6 h-full w-[80vw]  grid grid-cols-1 justify-center items-center mx-auto my-10 shadow-md md:grid-cols-2 gap-8">
      <div className='flex-col justify-center'>
        ...
        <img src={ProductImage} alt="Product" className="mt-4 rounded shadow-md h-96 mt-10 " />
      </div>
      <div>
        ...
        <img src={TeamImage} alt="Team" className="mt-4 rounded shadow-md h-96" />
      </div>
    </div>
  )
}
